...
@Component
public class ShowListSchedulesCommand implements Command {

    private final ScheduleService scheduleService;
    private final String MESSAGE = "Выберите год:";

    @Autowired
    public ShowListSchedulesCommand(ScheduleService scheduleService) {
    ...
    private InlineKeyboardMarkup getKeyboard() {
        ...
        for (Schedule schedule : scheduleService.getList()) {
            ...
            inlineKeyboardButton.setText(schedule.getYear());
            inlineKeyboardButton.setCallbackData(CommandName.GET_SCHEDULE_BY_ID_COMMAND.getCommandName() + " " + schedule.getId());
